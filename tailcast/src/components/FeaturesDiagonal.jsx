        ...
        <div className=' 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-customDarkBg1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col'>
          <div className='w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto'>
            ...
            <p className='mb-16 text-customGrayText leading-loose'>
              Our platform enables you to launch your data-driven projects with ease.
              Boost productivity and achieve better results. Empower your decision-making
          ...
          <div className='w-4/5 lg:w-1/2 lg:pl-16 flex justify-center mx-auto pt-16 lg:pt-0'>
            <img
              src='/images/featuresdiagonal.jpg'
              alt='f1'
